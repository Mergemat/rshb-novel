...
const school: DialogueMessage[] = [
  {
    character: "Evgeny",
    text: "Мы сидели за последней партой в кабинете биологии. В воздухе витал запах комнатных растений и моющих средств. Наши одноклассники ушли домой как два или три часа назад, а мы с Викей все возились с этой коробкой.",
    type: "internal",
  },
  {
    character: "Evgeny",
  ...
  {
    character: "Vika",
    text: "Женя, ты же сам мне говорил, как веришь в наш проект. И дело не только во времени и усилиях, а в главной цели нашей разработки. Да и сам подумай. Мы буквально из какой-то пластмассовой коробки сделали устройство для управления климатом! Как это можно так оставить?",
    type: "dialogue",
  },
  {
    character: "Evgeny",
  ...
  {
    character: "Evgeny",
    text: "Улыбнувшись, Фрейманс пошла в лаборантскую, а я на время остался со своими мыслями.",
    type: "internal",
  },
  {
    character: "Evgeny",
    text: "Я всегда был излишне прагматичен и рационален. С одной стороны это позволяло трезво оценивать свои силы и возможности, но с другой...мне не хватало того авантюризма, что есть в Вике. Возможно поэтому из нас получилась такая хорошая команда.",
    type: "internal",
  },
];
...
const konkurs: DialogueMessage[] = [
  {
    character: "Evgeny",
    text: "Тогда мы еще учились в 10 классе. Задерживались каждый день после уроков, чтобы улучшить нашу разработку. Сейчас, когда мы стоим на сцене и слушаем речь ведущего в качестве победителей, я понимаю, что Вика была права. Пожалуй, стоит поблагодарить её позже.",
    type: "internal",
  },
  {
    character: "Host",
    text: "Дорогие Виктория и Евгений! Поздравляем вас с победой в конкурсе. Ваша автоматизированная система жизнеобеспечения растений поразила наших жюри! В таком юном возрасте вы уже добились таких научных успехов!",
    type: "dialogue",
  },
  {
    character: "Vika",
  ...
  {
    character: "Evgeny",
    text: "Наверное, это первая настолько значимая для нас победа. Да, участие в школьных конкурсах и выставках дало какой-то полезный опыт, но получить признание от ведущих специалистов отрасли...это совсем другое. Изначально нам казалось это невозможным и настолько далеким, но работая вместе мы справились.",
    type: "internal",
  },
  {
    character: "Vika",
